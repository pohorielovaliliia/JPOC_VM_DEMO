Public Class DaoDrugDataCategorymaster
    Inherits AbstractTableDao

#Region "定数"
    Public Const TABLE_NAME As String = "T_JP_DrugDataCategorymaster"
#End Region
...
#Region "PrimaryKeyによる取得"
    Public Function GetCountByPK(ByVal pCtgId As Integer) As Integer
        Const SQL_QUERY As String = "SELECT COUNT(*) " & _
                                      "FROM " & TABLE_NAME & " " & _
                                     "WHERE ctgid = @ctgid"
        Try
...
#Region "削除"
    Public Function Delete(ByVal pCtgId As Integer) As Integer
...
#Region "追加"
    Public Function Insert(ByRef pDr As DS_DRUG.T_JP_DrugDataCategorymasterRow, _
        ...
        Try
            ...
            If pKeepIdValue Then
                strSQL = String.Format(IDENTITY_INSERT_ON, TABLE_NAME) & _
                         String.Format(SQL_QUERY, ",ctgid ", ",@ctgid ") & _
            ...
            Else
                pDr.ctgid = Utilities.N0Int(Me.DbManager.ExecuteScalar)
                If pDr.ctgid > 0 Then ret = 1
            End If
            Return ret
        Catch ex As ElsException
            ex.AddStackFrame(New StackFrame(True))
...
#Region "更新"
    Public Function Update(ByRef pDr As DS_DRUG.T_JP_DrugDataCategorymasterRow) As Integer
