...
Public Class DaoTreeCategory
    Inherits AbstractTableDao

#Region "定数"
    Public Const TABLE_NAME As String = "T_JP_TreeCategory"
#End Region
...
#Region "CategoryTypeによる取得"
    Public Function GetByCategoryType(ByRef pDt As DataTable, _
                                      ByVal pCategoryType As String, _
                                      Optional ByVal IsRemoveTitle As Boolean = False) As Integer
        Const SQL_QUERY As String = "SELECT * " & _
                                      "FROM " & TABLE_NAME & " " & _
                                     "WHERE category_type = @category_type"
        Try
            Dim strSql As String = SQL_QUERY
            If IsRemoveTitle Then strSql &= " AND title_flag = 0 "
            Me.DbManager.SetSqlCommand(strSql, CommandType.Text)
            Me.DbManager.SetCmdParameter("@category_type", SqlDbType.VarChar, ParameterDirection.Input, pCategoryType)
            Return Me.DbManager.ExecuteAndGetDataTable(pDt, True)
        Catch ex As ElsException
            ex.AddStackFrame(New StackFrame(True))
            Throw ex
