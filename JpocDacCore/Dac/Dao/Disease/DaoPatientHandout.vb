Public Class DaoPatientHandout
    Inherits AbstractTableDao

#Region "定数"
    Public Const TABLE_NAME As String = "T_JP_PatientHandout"
#End Region
...
#Region "追加"
    Public Function Insert(ByRef pDr As DS_DISEASE.T_JP_PatientHandoutRow, _
        ...
        Try
            ...
            Me.DbManager.SetCmdParameter("@notes", SqlDbType.NText, ParameterDirection.Input, pDr.notes)
            Me.DbManager.SetCmdParameter("@instruction", SqlDbType.NText, ParameterDirection.Input, pDr.instruction)
            Me.DbManager.SetCmdParameter("@final_output", SqlDbType.NText, ParameterDirection.Input, pDr.final_output)
            ...
            If Not pDr.IsNull("checkout_date") Then
                Me.DbManager.SetCmdParameter("@checkout_date", SqlDbType.DateTime, ParameterDirection.Input, pDr.checkout_date)
            Else
                Me.DbManager.SetCmdParameter("@checkout_date", SqlDbType.DateTime, ParameterDirection.Input, DBNull.Value)
            End If
            Me.DbManager.SetCmdParameter("@defunct", SqlDbType.Bit, ParameterDirection.Input, pDr.defunct)
            If Not pDr.IsNull("desription_code") Then
                Me.DbManager.SetCmdParameter("@desription_code", SqlDbType.NVarChar, ParameterDirection.Input, pDr.desription_code)
            Else
                Me.DbManager.SetCmdParameter("@desription_code", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value)
            End If
            If Not pDr.IsNull("notes_code") Then
                Me.DbManager.SetCmdParameter("@notes_code", SqlDbType.NVarChar, ParameterDirection.Input, pDr.notes_code)
            Else
                Me.DbManager.SetCmdParameter("@notes_code", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value)
            End If
            If Not pDr.IsNull("instruction_code") Then
                Me.DbManager.SetCmdParameter("@instruction_code", SqlDbType.NVarChar, ParameterDirection.Input, pDr.instruction_code)
            Else
                Me.DbManager.SetCmdParameter("@instruction_code", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value)
            End If
            If Not pDr.IsNull("description_title") Then
                Me.DbManager.SetCmdParameter("@description_title", SqlDbType.NVarChar, ParameterDirection.Input, pDr.description_title)
            Else
                Me.DbManager.SetCmdParameter("@description_title", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value)
            End If
            If Not pDr.IsNull("notes_title") Then
                Me.DbManager.SetCmdParameter("@notes_title", SqlDbType.NVarChar, ParameterDirection.Input, pDr.notes_title)
            Else
                Me.DbManager.SetCmdParameter("@notes_title", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value)
            End If
            If Not pDr.IsNull("instruction_title") Then
                Me.DbManager.SetCmdParameter("@instruction_title", SqlDbType.NVarChar, ParameterDirection.Input, pDr.instruction_title)
            Else
                Me.DbManager.SetCmdParameter("@instruction_title", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value)
            End If
            ...
            Else
                Dim patientHandoutId As Integer = Utilities.N0Int(Me.DbManager.ExecuteScalar)
                pDr.id = patientHandoutId
...
#Region "更新"
    Public Function Update(ByRef pDr As DS_DISEASE.T_JP_PatientHandoutRow) As Integer
        Const SQL_QUERY As String = "UPDATE " & TABLE_NAME & " " & _
                                       "SET " & _
                                            ...
                                            ",checkout_date = @checkout_date " & _
                                            ",defunct = @defunct " & _
                                            ",desription_code = @desription_code " & _
                                            ",notes_code = @notes_code " & _
                                            ",instruction_code = @instruction_code " & _
                                            ",description_title = @description_title " & _
                                            ",notes_title = @notes_title " & _
                                            ",instruction_title = @instruction_title " & _
                                    "WHERE id = @id "
        ...
        Try
            ...
            Else
                Me.DbManager.SetCmdParameter("@notes_code", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value)
            End If
            If Not pDr.IsNull("pDr.instruction_code") Then
                Me.DbManager.SetCmdParameter("@instruction_code", SqlDbType.NVarChar, ParameterDirection.Input, pDr.instruction_code)
            Else
                Me.DbManager.SetCmdParameter("@instruction_code", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value)
            End If
