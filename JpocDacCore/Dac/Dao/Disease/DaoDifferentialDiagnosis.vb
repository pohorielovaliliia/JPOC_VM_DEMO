Public Class DaoDifferentialDiagnosis
    Inherits AbstractTableDao

#Region "定数"
    Public Const TABLE_NAME As String = "T_JP_DifferentialDiagnosis"
#End Region
...
#Region "追加"
    Public Function Insert(ByRef pDr As DS_DISEASE.T_JP_DifferentialDiagnosisRow, _
                           ByVal pKeepIdValue As Boolean) As Integer
        Const SQL_QUERY As String = "INSERT INTO " & TABLE_NAME & " (" & _
                                                                         "guid " & _
                                                                        ",disease_id " & _
                                                                        ",differential_diagnosis " & _
                                                                        ",sequence " & _
                                                                        ",status " & _
        ...
        Try
            ...
            Me.DbManager.SetCmdParameter("@differential_diagnosis", SqlDbType.NText, ParameterDirection.Input, pDr.differential_diagnosis)
...
#Region "更新"
    Public Function Update(ByRef pDr As DS_DISEASE.T_JP_DifferentialDiagnosisRow) As Integer
        Const SQL_QUERY As String = "UPDATE " & TABLE_NAME & " " & _
                                       "SET " & _
                                             "guid = @guid " & _
                                            ",disease_id = @disease_id " & _
                                            ",differential_diagnosis = @differential_diagnosis " & _
                                            ",sequence = @sequence " & _
                                            ",status = @status " & _
