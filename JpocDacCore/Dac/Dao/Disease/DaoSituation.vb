...
#Region "定数"
    Public Const TABLE_NAME As String = "T_JP_Situation"
#End Region
...
#Region "DiseaseIDによる一覧取得"
    Public Function GetCountByDiseaseID(ByRef pDt As DataTable, _
...
#Region "DiseaseID及びDocIdによる一覧取得"
...
#Region "追加"
    Public Function Insert(ByRef pDr As DS_DISEASE.T_JP_SituationRow, _
        ...
        Try
            ...
            Me.DbManager.SetCmdParameter("@see_instead", SqlDbType.NText, ParameterDirection.Input, pDr.see_instead)
            Me.DbManager.SetCmdParameter("@see_also", SqlDbType.NText, ParameterDirection.Input, pDr.see_also)
            ...
            Else
                Dim situationId As Integer = Utilities.N0Int(Me.DbManager.ExecuteScalar)
                pDr.id = situationId
...
#Region "更新"
    Public Function Update(ByRef pDr As DS_DISEASE.T_JP_SituationRow) As Integer
