...
#Region "定数"
    Public Const TABLE_NAME As String = "T_JP_Evidence"
#End Region
...
#Region "DiseaseIDによる取得"
    Public Function GetCountByDiseaseID(ByVal pDiseaseID As Integer, _
        ...
        Try
            ...
            If pOnlyActive Then
                strSql = String.Format(SQL_QUERY, " AND " & MyBase.ActiveCondition)
            Else
...
#Region "削除"
    ...
    ''' DiseaseIdによる削除
    ''' </summary>
    ''' <param name="pDiseaseId">DiseaseId</param>
    ''' <returns></returns>
    ''' <remarks></remarks>
...
#Region "追加"
    Public Function Insert(ByRef pDr As DS_DISEASE.T_JP_EvidenceRow, _
        ...
        Try
            ...
            Me.DbManager.SetCmdParameter("@header_message", SqlDbType.NVarChar, ParameterDirection.Input, pDr.header_message)
            ...
            Me.DbManager.SetCmdParameter("@type", SqlDbType.Char, ParameterDirection.Input, pDr.type)
            ...
            End If
            If Not pDr.IsNull("comment") Then
                Me.DbManager.SetCmdParameter("@comment", SqlDbType.NVarChar, ParameterDirection.Input, pDr.comment)
            Else
                Me.DbManager.SetCmdParameter("@comment", SqlDbType.NVarChar, ParameterDirection.Input, DBNull.Value)
            End If
            ...
            Else
                Dim evidenceID As Integer = Utilities.N0Int(Me.DbManager.ExecuteScalar)
                pDr.id = evidenceID
...
#Region "更新"
    Public Function Update(ByRef pDr As DS_DISEASE.T_JP_EvidenceRow) As Integer
